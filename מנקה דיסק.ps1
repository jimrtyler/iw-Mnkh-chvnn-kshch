...
#GUI Variables
$FormTitleText = "מנקה דיסק מאת ג'ים טיילר (PowerShellEngineer.com)"
$SelectDiskLabelText = "בחר דיסק:"
$FreeSpaceLabelText = "שטח פנוי (ג'יגה-בייט): "
$TotalSpaceLabelText = "Total Space (GB)"
$JunkFoundLabelText = "Junk Found (GB)"
$CleanDiskBtnText = "נקה דיסק *מחק קבצים*"
$SpaceCleanedLabelText = "שטח נקי (ג'יגה-בייט): "
$LogFileLabelText = "נמצא קובץ יומן: $abcdefg"
$CreditLabelText = "תסריט מאת ג'ים טיילר - PowerShellEngineer.com"
$LogFileLocatedText = "נמצא קובץ יומן"
$AnalyzingDriveText = "מנתח כוננים..."
$BrowsersAreRunningText = "דפדפנים פועלים... הודע למשתמש..."
$PleaseCloseBrowsersText = "אנא סגור את כל דפדפני האינטרנט ונסה שוב."
$CleaningDriveText = "מנקה את הכונן..."
